...
} CIA402CSP_CONTROLWORD_OBJ;/* 0x6040 */
...
} CIA402CSP_STATUSWORD_OBJ;/* 0x6041 */

typedef struct{
	CIA402CSP_STATE State;
} CIA402CSP_CTRL_OBJ;

/* GLOBAL VARIABLES */
extern CIA402_FUNC_INTF CIA402CSP_FuncIntf;

/* EXPORTED SUBPROGRAM SPECIFICATIONS */ 
int32_t CIA402CSP_Init(void *pAxis);
int32_t CIA402CSP_DeInit(void *pAxis);
int32_t CIA402CSP_Run(void *pAxis);

#endif /* __CIA402CSP_H__ */
