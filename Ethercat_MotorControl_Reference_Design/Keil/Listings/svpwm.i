...
#line 33 "..\\Source\\McStack\\svpwm.c"
...
void MS_SetPhaseVoltage(MS_Epwm_Handle_t *pHandle, MCMATH_AB_PHASE_T Vab)
{
	...
	(mapMemory[((420)+0)]) = (u * 2) - 1000;
	(mapMemory[((420)+1)]) = (v * 2) - 1000;
	(mapMemory[((420)+2)]) = (w * 2) - 1000;

	 
	(pHandle ->EpwmRegister . pInst->CMPDAT[0] = ((mapMemory[((420)+10)]) - (mapMemory[((420)+0)])));
	(pHandle ->EpwmRegister . pInst->CMPDAT[2] = ((mapMemory[((420)+10)]) - (mapMemory[((420)+1)])));
	(pHandle ->EpwmRegister . pInst->CMPDAT[4] = ((mapMemory[((420)+10)]) - (mapMemory[((420)+2)])));
}  
