#line 1 "..\\For_SSC_Tool\\Src\\coeappl.c"
...
#line 112 "..\\For_SSC_Tool\\Src\\coeappl.c"
...
#line 115 "..\\For_SSC_Tool\\Src\\coeappl.c"
...
;
 ...
 unsigned long u32LastDc32Value;
 unsigned long u32CheckForDcOverrunCnt;
...
#line 118 "..\\For_SSC_Tool\\Src\\coeappl.c"
...
const unsigned char  aName0x1600[] = "RxPdoMappingCspCsv\000"
"SubIndex 001\000"
"SubIndex 002\000"
"SubIndex 003\000"
"SubIndex 004\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0x1601[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 }};  
...
const unsigned char  aName0x1601[] = "RxPdoMappingCsp\000"
"SubIndex 001\000"
"SubIndex 002\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0x1602[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 }};  
...
const unsigned char  aName0x1602[] = "RxPdoMappingCsv\000"
"SubIndex 001\000"
"SubIndex 002\000"
"SubIndex 003\000\377";
...
const unsigned char  aName0x1A00[] = "TxPdoMappingCspCsv\000"
"SubIndex 001\000"
"SubIndex 002\000"
"SubIndex 003\000"
"SubIndex 004\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0x1A01[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 }};  
...
const unsigned char  aName0x1A01[] = "TxPdoMappingCsp\000"
"SubIndex 001\000"
"SubIndex 002\000"
"SubIndex 003\000\377";
...
const TSDOINFOENTRYDESC     asEntryDesc0x1A02[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 },  
{ 0x0007 , 0x20 , 0x0007 }};  
...
const unsigned char  aName0x1A02[] = "TxPdoMappingCsv\000"
"SubIndex 001\000"
"SubIndex 002\000"
"SubIndex 003\000\377";
...
const unsigned char  aName0x1C12[] = "SM2 assignment\000\377";
...
const unsigned char  aName0x1C13[] = "SM3 assignment\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x603F = { 0x0006 , 0x10 , 0x0007 };


 
const unsigned char  aName0x603F[] = "Error Code\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x6040 = { 0x0006 , 0x10 , 0x003F };


 
const unsigned char  aName0x6040[] = "Controlword\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x6041 = { 0x0006 , 0x10 , 0x0007 };


 
const unsigned char  aName0x6041[] = "Statusword\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x604F = { 0x0007 , 0x20 , 0x003F };


 
const unsigned char  aName0x604F[] = "Vl Ramp Function Time\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x605A = { 0x0003 , 0x10 , 0x003F };


 
const unsigned char  aName0x605A[] = "Quick stop option code\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x605B = { 0x0003 , 0x10 , 0x003F };


 
const unsigned char  aName0x605B[] = "Shutdown option code\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x605C = { 0x0003 , 0x10 , 0x003F };


 
const unsigned char  aName0x605C[] = "Disable operation option code\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x605E = { 0x0003 , 0x10 , 0x003F };


 
const unsigned char  aName0x605E[] = "Fault reaction option code\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x6060 = { 0x0002 , 0x08 , 0x003F };


 
const unsigned char  aName0x6060[] = "Modes of operation\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x6061 = { 0x0002 , 0x08 , 0x0007 };


 
const unsigned char  aName0x6061[] = "Modes of operation display\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x6064 = { 0x0004 , 0x20 , 0x0007 };


 
const unsigned char  aName0x6064[] = "Position actual value\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x606C = { 0x0004 , 0x20 , 0x0007 };


 
const unsigned char  aName0x606C[] = "Velocity actual value\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x6077 = { 0x0004 , 0x20 , 0x0007 };


 
const unsigned char  aName0x6077[] = "Torque actual value\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x607A = { 0x0004 , 0x20 , 0x003F };


 
const unsigned char  aName0x607A[] = "Target position\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x607C = { 0x0004 , 0x20 , 0x003F };


 
const unsigned char  aName0x607C[] = "Home offset\000\377";
...
const TSDOINFOENTRYDESC     asEntryDesc0x607D[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0004 , 0x20 , 0x003F },  
{ 0x0004 , 0x20 , 0x003F }};  
...
const unsigned char  aName0x607D[] = "Software position limit\000"
...
const TSDOINFOENTRYDESC     sEntryDesc0x6085 = { 0x0007 , 0x20 , 0x003F };


 
const unsigned char  aName0x6085[] = "Quick stop deceleration\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x6098 = { 0x0002 , 0x08 , 0x003F };


 
const unsigned char  aName0x6098[] = "Homing method\000\377";
...
const TSDOINFOENTRYDESC     asEntryDesc0x6099[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x003F },  
{ 0x0007 , 0x20 , 0x003F }};  
...
const unsigned char  aName0x6099[] = "Homing speed\000"
...
const TSDOINFOENTRYDESC     sEntryDesc0x609A = { 0x0007 , 0x20 , 0x003F };


 
const unsigned char  aName0x609A[] = "Homing acceleration\000\377";
...
const TSDOINFOENTRYDESC     asEntryDesc0x60C2[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0005 , 0x08 , 0x003F },  
{ 0x0002 , 0x08 , 0x003F }};  
...
const unsigned char  aName0x60C2[] = "Interpolation time period\000"
...
const TSDOINFOENTRYDESC     asEntryDesc0x60E3[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0002 , 0x08 , 0x0007 },  
{ 0x0002 , 0x08 , 0x0007 }};  
...
const unsigned char  aName0x60E3[] = "Supported homing mode\000"
...
const TSDOINFOENTRYDESC     sEntryDesc0x60FD = { 0x0007 , 0x20 , 0x0007 };


 
const unsigned char  aName0x60FD[] = "Digital inputs\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x60FF = { 0x0004 , 0x20 , 0x003F };


 
const unsigned char  aName0x60FF[] = "Target velocity\000\377";
...
const TSDOINFOENTRYDESC     sEntryDesc0x6502 = { 0x0007 , 0x20 , 0x0007 };


 
const unsigned char  aName0x6502[] = "Supported drive modes\000\377";
...
const TSDOINFOENTRYDESC     asEntryDesc0xF010[] = {
{ 0x0005 , 0x8 , 0x0007 },
{ 0x0007 , 0x20 , 0x0007 }};
...
const unsigned char  aName0xF010[] = "Module profile list\000\377";
...
{0 , 0 ,  0x1600 , {0x0021 , 5 | (0x09 << 8)} , asEntryDesc0x1600 , aName0x1600 , &RxPdoMappingCspCsv0x1600 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x1601 , {0x0021 , 3 | (0x09 << 8)} , asEntryDesc0x1601 , aName0x1601 , &RxPdoMappingCsp0x1601 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x1602 , {0x0021 , 3 | (0x09 << 8)} , asEntryDesc0x1602 , aName0x1602 , &RxPdoMappingCsv0x1602 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x1A00 , {0x0021 , 5 | (0x09 << 8)} , asEntryDesc0x1A00 , aName0x1A00 , &TxPdoMappingCspCsv0x1A00 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x1A01 , {0x0021 , 3 | (0x09 << 8)} , asEntryDesc0x1A01 , aName0x1A01 , &TxPdoMappingCsp0x1A01 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x1A02 , {0x0021 , 3 | (0x09 << 8)} , asEntryDesc0x1A02 , aName0x1A02 , &TxPdoMappingCsv0x1A02 , 0 , 0 , 0x0000 },
...
{0 , 0 ,  0x603F , {0x0006 , 0 | (0x07 << 8)} , &sEntryDesc0x603F , aName0x603F , &ErrorCode0x603F , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6040 , {0x0006 , 0 | (0x07 << 8)} , &sEntryDesc0x6040 , aName0x6040 , &Controlword0x6040 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6041 , {0x0006 , 0 | (0x07 << 8)} , &sEntryDesc0x6041 , aName0x6041 , &Statusword0x6041 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x604F , {0x0007 , 0 | (0x07 << 8)} , &sEntryDesc0x604F , aName0x604F , &VlRampFunctionTime0x604F , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x605A , {0x0003 , 0 | (0x07 << 8)} , &sEntryDesc0x605A , aName0x605A , &QuickStopOptionCode0x605A , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x605B , {0x0003 , 0 | (0x07 << 8)} , &sEntryDesc0x605B , aName0x605B , &ShutdownOptionCode0x605B , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x605C , {0x0003 , 0 | (0x07 << 8)} , &sEntryDesc0x605C , aName0x605C , &DisableOperationOptionCode0x605C , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x605E , {0x0003 , 0 | (0x07 << 8)} , &sEntryDesc0x605E , aName0x605E , &FaultReactionOptionCode0x605E , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6060 , {0x0002 , 0 | (0x07 << 8)} , &sEntryDesc0x6060 , aName0x6060 , &ModesOfOperation0x6060 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6061 , {0x0002 , 0 | (0x07 << 8)} , &sEntryDesc0x6061 , aName0x6061 , &ModesOfOperationDisplay0x6061 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6064 , {0x0004 , 0 | (0x07 << 8)} , &sEntryDesc0x6064 , aName0x6064 , &PositionActualValue0x6064 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x606C , {0x0004 , 0 | (0x07 << 8)} , &sEntryDesc0x606C , aName0x606C , &VelocityActualValue0x606C , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6077 , {0x0004 , 0 | (0x07 << 8)} , &sEntryDesc0x6077 , aName0x6077 , &TorqueActualValue0x6077 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x607A , {0x0004 , 0 | (0x07 << 8)} , &sEntryDesc0x607A , aName0x607A , &TargetPosition0x607A , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x607C , {0x0004 , 0 | (0x07 << 8)} , &sEntryDesc0x607C , aName0x607C , &HomeOffset0x607C , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x607D , {0x002A , 2 | (0x09 << 8)} , asEntryDesc0x607D , aName0x607D , &SoftwarePositionLimit0x607D , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6085 , {0x0007 , 0 | (0x07 << 8)} , &sEntryDesc0x6085 , aName0x6085 , &QuickStopDeceleration0x6085 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6098 , {0x0002 , 0 | (0x07 << 8)} , &sEntryDesc0x6098 , aName0x6098 , &HomingMethod0x6098 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6099 , {0x002A , 2 | (0x09 << 8)} , asEntryDesc0x6099 , aName0x6099 , &HomingSpeed0x6099 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x609A , {0x0007 , 0 | (0x07 << 8)} , &sEntryDesc0x609A , aName0x609A , &HomingAcceleration0x609A , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x60C2 , {0x002A , 2 | (0x09 << 8)} , asEntryDesc0x60C2 , aName0x60C2 , &InterpolationTimePeriod0x60C2 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x60E3 , {0x002A , 2 | (0x09 << 8)} , asEntryDesc0x60E3 , aName0x60E3 , &SupportedHomingMode0x60E3 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x60FD , {0x0007 , 0 | (0x07 << 8)} , &sEntryDesc0x60FD , aName0x60FD , &DigitalInputs0x60FD , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x60FF , {0x0004 , 0 | (0x07 << 8)} , &sEntryDesc0x60FF , aName0x60FF , &TargetVelocity0x60FF , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0x6502 , {0x0007 , 0 | (0x07 << 8)} , &sEntryDesc0x6502 , aName0x6502 , &SupportedDriveModes0x6502 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0xF000 , {0x002A , 2 | (0x09 << 8)} , asEntryDesc0xF000 , aName0xF000 , &ModularDeviceProfile0xF000 , 0 , 0 , 0x0000 },
 
{0 , 0 ,  0xF010 , {0x0007 , 1 | (0x08 << 8)} , asEntryDesc0xF010 , aName0xF010 , &ModuleProfileList0xF010 , 0 , 0 , 0x0000 },
...
#line 126 "..\\For_SSC_Tool\\Src\\coeappl.c"
...
unsigned long u32Devicetype = (0x00020192);
...
char acDevicename[] = "AX58200_MotorControl";



 
const TSDOINFOENTRYDESC     sEntryDesc0x1008 = {0x0009, ((0x14)<<3), 0x0007};
...
const unsigned char  aName0x1009[] = "Hardware version";
...
const unsigned char  aName0x100A[] = "Software version";
...
TOBJ1018 sIdentity = {4, (0xC3C), (0x80000300), (0x00312000), (0x00000000)};
...
const unsigned char  aName0x1018[] = "Identity\000Vendor ID\000Product code\000Revision\000Serial number\000\377";
...
unsigned char Read0x10F8(unsigned short index, unsigned char subindex, unsigned long dataSize, unsigned short  * pData, unsigned char bCompleteAccess)
{
...
void COE_SyncTimeStamp(void)
{
    ...
    if (b32BitDc)
    {
        unsigned long DcTime = (unsigned long)(u64Timestamp & (unsigned long long)0x00000000FFFFFFFF);


        HW_EscRead(((unsigned long *)&(DcTime)),((unsigned short)(0x0910)),4);
    ...
    else
    {
        ...
        HW_EscRead((unsigned long *)&u64Timestamp, 0x0910, 8);
    }
...
void COE_ObjInit(void)
{
    ...
    unsigned long EscFeature = 0;
    HW_EscRead(((unsigned long *)&(EscFeature)),((unsigned short)(0x0008)),4);
    ...
    else
    {
        ...
        HW_EscRead(((unsigned long *)&(u32LastDc32Value)),((unsigned short)(0x0910)),4);
    }
