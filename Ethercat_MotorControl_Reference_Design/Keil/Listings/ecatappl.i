#line 1 "..\\For_SSC_Tool\\Src\\ecatappl.c"
...
#line 127 "..\\For_SSC_Tool\\Src\\ecatappl.c"
...
#line 85 "..\\For_SSC_Tool\\Src\\ecatappl.h"
 ...
 unsigned char bRunApplication;  
    ...
    unsigned short     ESC_EepromAccess(unsigned long wordaddress, unsigned short wordsize, unsigned short  *pData, unsigned char access);
...
#line 130 "..\\For_SSC_Tool\\Src\\ecatappl.c"
...
#line 134 "..\\For_SSC_Tool\\Src\\ecatappl.c"
...
#line 50 "..\\For_SSC_Tool\\Src\\applInterface.h"
 ...
 unsigned short (*pAPPL_FoeRead)(unsigned short  * pName, unsigned short nameSize, unsigned long password, unsigned short maxBlockSize, unsigned short *pData);
 ...
 unsigned short(*pAPPL_FoeReadData)(unsigned long offset, unsigned short maxBlockSize, unsigned short *pData);
 ...
 void(*pAPPL_FoeError)(unsigned long errorCode);
 ...
 unsigned short (*pAPPL_FoeWrite)(unsigned short  * pName, unsigned short nameSize, unsigned long password);
...
#line 139 "..\\For_SSC_Tool\\Src\\ecatappl.c"
...
#line 142 "..\\For_SSC_Tool\\Src\\ecatappl.c"
...
#line 159 "..\\For_SSC_Tool\\Src\\ecatappl.c"
...
unsigned long u32CycleTimeStartValue;  

unsigned long u32MinCycleTimeStartValue;  

unsigned long u32SystemTimeReadFailure;  

unsigned char bMinCycleTimeMeasurementStarted;  

unsigned long u32MinCycleTimeValue;  
...
unsigned short             aPdOutputData[(0x044>>1)];
unsigned short           aPdInputData[(0x0044>>1)];

 
    extern volatile unsigned char u8dummy;
...
unsigned long GetSystemTimeDelay(unsigned long u32StartTime);
...
void PDO_InputMapping(void)
{
    ...
    HW_EscWriteIsr(((unsigned long *) aPdInputData), nEscAddrInputData, nPdInputSize );
...
#line 280 "..\\For_SSC_Tool\\Src\\ecatappl.c"
    }
...
void PDO_OutputMapping(void)
{
   ...
   if ((((sSyncManOutPar . u16GetCycleTime & 0x1) == 0x1) || ((sSyncManInPar . u16GetCycleTime & 0x1) == 0x1)))
   {
    ...
    HW_EscReadIsr(((unsigned long *)aPdOutputData), nEscAddrOutputData, nPdOutputSize );
...
unsigned long GetSystemTimeDelay(unsigned long u32StartTime)
{
   unsigned long u32CurValue = 0;
   unsigned long u32Delta = 0;

   
   HW_EscReadIsr(((unsigned long *)&(u32CurValue)),((unsigned short)(0x0910)),4);
...
void PDI_Isr(void)
{
    if(bEscIntEnabled)
    {
        ...
        else
        {
            ...
            HW_EscReadIsr(((unsigned long *)&(u8dummy)),((unsigned short)(nEscAddrOutputData)),1);
            HW_EscReadIsr(((unsigned long *)&(u8dummy)),((unsigned short)((nEscAddrOutputData+nPdOutputSize - 1))),1);
        }
        }
...
void Sync0_Isr(void)
{
    ...
    if(bDcSyncActive)
    {
        ...
        if ( bEcatInputUpdateRunning 
           && (LatchInputSync0Value > 0) && (LatchInputSync0Value == LatchInputSync0Counter) )  
        {
...
unsigned short MainInit(void)
{
    ...
    HW_EscRead(((unsigned long *)&(eepromConfigControl)),((unsigned short)(0x0500)),2);
    ...
    if((eepromConfigControl & 0x0001) > 0)
    {
        ...
        eepromConfigControl = (eepromConfigControl);
        HW_EscWrite(((unsigned long *)&(eepromConfigControl)),((unsigned short)(0x0500)),2);
    }
    }
    ...
    {
       unsigned long u32TimeValue = 0;
       unsigned long u32Cnt = 0;
       unsigned long u32Delta = 0;

       while (u32Cnt < 1000)
       {
           HW_EscReadIsr(((unsigned long *)&(u32TimeValue)),((unsigned short)(0x0910)),4);
           HW_EscReadIsr(((unsigned long *)&(u32Delta)),((unsigned short)(0x0910)),4);
...
void ECAT_Application(void)
{
#line 891 "..\\For_SSC_Tool\\Src\\ecatappl.c"
...
#line 943 "..\\For_SSC_Tool\\Src\\ecatappl.c"
}
...
unsigned short ESC_EepromAccess(unsigned long wordaddress, unsigned short wordsize, unsigned short  *pData, unsigned char access)
{
    ...
    HW_EscRead(((unsigned long *)&(nConfig)),((unsigned short)(0x0500)),2);
    HW_EscRead(((unsigned long *)&(nControl)),((unsigned short)(0x0502)),2);
    ...
    if ( nConfig & 0x0001 )
    {
        ...
        nConfig = 0x0100;
        HW_EscWrite(((unsigned long *)&(nConfig)),((unsigned short)(0x0500)),2);
        for (i = 0; i < wordsize;)
        {
             
            HW_EscWrite((unsigned long *) &wordaddress, 0x0504, 4);
            ...
            if ( access == 1 )
            {
                ...
                nControl = 0x0100;
                HW_EscWrite(((unsigned long *)&(nControl)),((unsigned short)(0x0502)),2);
            }
            else
            {
                 
                HW_EscWrite(((unsigned long *)&(pData[i])),((unsigned short)(0x0508)),2);
            ...
            else
            {
                if ( access == 1 )
                {
                    ...
                    HW_EscRead((unsigned long *) &pData[i], 0x0508, u16BytesToCopy);
                }
            }
            ...
            else
            {
                ...
                if(RetryCnt > 0)
                {
                    ...
                    long i32TimeoutTicks = (long)(1 * (11/ 10));
 
                    unsigned short u16CurTimer = 0;
                    unsigned short u16LastTimer = ((unsigned short)((((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CNT & 0xffffful)>>6));
                    unsigned short Delta = 0;

                     
                    while(i32TimeoutTicks > 0)
                    {
                        u16CurTimer = ((unsigned short)((((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CNT & 0xffffful)>>6));
...
unsigned short ESC_EepromWriteCRC(void)
{
    ...
    u16Return = ESC_EepromAccess(0,7,(unsigned short *)EscCfgData,1);
    if(u16Return == 0)
    {
        ...
        u16Return = ESC_EepromAccess(7,1,&u16Crc,2);
        if(u16Return == 0)
        {
            u16Return =  0x0020;
        }
