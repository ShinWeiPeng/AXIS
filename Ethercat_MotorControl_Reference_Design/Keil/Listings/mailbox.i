#line 1 "..\\For_SSC_Tool\\Src\\mailbox.c"
...
#line 133 "..\\For_SSC_Tool\\Src\\mailbox.c"
...
#line 136 "..\\For_SSC_Tool\\Src\\mailbox.c"
...
#line 141 "..\\For_SSC_Tool\\Src\\mailbox.c"
...
#line 145 "..\\For_SSC_Tool\\Src\\mailbox.c"
...
#line 147 "..\\For_SSC_Tool\\Src\\mailbox.c"
...
#line 149 "..\\For_SSC_Tool\\Src\\mailbox.c"
...
void MBX_Init(void)
{
    ...
    u16SendMbxSize = 0x0080;
    u16EscAddrReceiveMbx = 0x1000;
    u16EscAddrSendMbx = 0x1000;
    ...
    {
        unsigned char sm1Activate = 0;
        HW_EscRead(((unsigned long *)&(sm1Activate)),((unsigned short)((0x0807 + 8))),1);
        sm1Activate &= ~0x02;
...
void MBX_CheckAndCopyMailbox( void )
{
    ...
    HW_EscRead(((unsigned long *)&(mbxLen)),((unsigned short)(u16EscAddrReceiveMbx)),2);
    ...
    else
    {
        ...
        HW_EscRead(((unsigned long *)((unsigned long *) psWriteMbx)),((unsigned short)(u16EscAddrReceiveMbx)),(mbxLen));


        {
         
        volatile unsigned char smstate = 0x00;
        HW_EscRead(((unsigned long *)&(smstate)),((unsigned short)(0x0805)),1);

        if(smstate & 0x08)
        {
             
            u8dummy = 0;
            HW_EscRead(((unsigned long *)&(u8dummy)),((unsigned short)((u16EscAddrReceiveMbx + u16ReceiveMbxSize - 1))),1);
...
unsigned char MBX_CopyToSendMailbox( TMBX  *pMbx )
{
    ...
    else
    {
        ...
        HW_EscWrite(((unsigned long *)((unsigned long *)pMbx)),((unsigned short)(u16EscAddrSendMbx)),((mbxSize + 6)));
 

        {
         
        volatile unsigned char smstate = 0x00;
        HW_EscRead(((unsigned long *)&(smstate)),((unsigned short)((0x0805 + 8))),1);
        ...
        if(!(smstate & 0x08))
        {
            ...
            u8dummy = 0;
            HW_EscWrite(((unsigned long *)&(u8dummy)),((unsigned short)((u16EscAddrSendMbx + u16SendMbxSize - 1))),1);
        }
        }
