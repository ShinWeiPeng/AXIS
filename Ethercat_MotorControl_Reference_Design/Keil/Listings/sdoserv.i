#line 1 "..\\For_SSC_Tool\\Src\\sdoserv.c"
...
#line 109 "..\\For_SSC_Tool\\Src\\sdoserv.c"
...
#line 111 "..\\For_SSC_Tool\\Src\\sdoserv.c"
...
#line 579 "..\\For_SSC_Tool\\Src\\sdoserv.h"
 ...
 unsigned long        u32StoreDataSize;  
 unsigned short  *pStoreData;  
 unsigned char (* pSdoPendFunc)( unsigned short Index, unsigned char Subindex, unsigned long Size, unsigned short  * pData, unsigned char bCompleteAccess );  
 


 unsigned long                      aSdoInfoHeader[(((((( (6) + (2) + (4) ))+(2)))+3) >> 2)];  
 ...
 unsigned short                          nSdoInfoFragmentsLeft;  
    ...
    void  SDOS_SdoRes(unsigned char abort, unsigned long objLength, unsigned short  *pData);
 
    void  SODS_ClearPendingResponse(void);
...
#line 115 "..\\For_SSC_Tool\\Src\\sdoserv.c"
...
const unsigned long  cAbortCode[] =
{
    0x00000000,
    0x05030000,
    0x05040000,
...
unsigned long                            nSdoSegBytesToHandle;
unsigned char                             bSdoSegLastToggle;
unsigned long                            nSdoSegCompleteSize;
        ...
        if ( pSdoSegData )
        {
            ...
            if ( pSdoInd->SdoHeader.SegHeader & ((unsigned short) 0x01) )
            {
                ...
                if ( bytesToSave <= maxData )
                {
                    ...
                    if (((bytesToSave <= (unsigned long)(mbxSize - ( 2 + 1 )))
                        ...
                        && (bytesToSave == (unsigned long)(mbxSize - ( 2 + 1 )))
                        ) )
                    {
...
static unsigned char SdoUploadSegmentInd( TUPLOADSDOSEGREQMBX  * pSdoInd )
{
   ...
   if ( (pSdoInd->SegHeader & ((unsigned short) 0x10)) == bSdoSegLastToggle )
    ...
    else
    {
        ...
        {	
            unsigned short i = 0;
            unsigned long nIndexOffset = nSdoSegBytesToHandle >> 1;
...
void SdoRes(unsigned char abort, unsigned char command, unsigned char completeAccess, unsigned short dataSize, unsigned long objLength, TINITSDOMBX  *pSdoRes)
{
        ...
        if ( pObjEntry )
        {
 ...
 
            {
                ...
                else
                {
                    ...
                    unsigned long downloadSize = ((unsigned long)((((TINITSDODOWNLOADNORMREQMBX *) pSdoInd)->CompleteSize[1]))<<16) + ((((TINITSDODOWNLOADNORMREQMBX *) pSdoInd)->CompleteSize[0]));
                    ...
                    if ( dataSize > (unsigned long)(mbxSize - ( 2 + 4 + 4 )) )
                    {
            ...
            if ((abort == 0) && (sdoHeader & ((unsigned char) 0x10) ))
