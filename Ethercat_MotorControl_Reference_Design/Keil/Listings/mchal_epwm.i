#line 1 "..\\Source\\Mchal\\McHal_epwm.c"
...
#line 33 "..\\Source\\Mchal\\McHal_epwm.c"
...
#line 34 "..\\Source\\Mchal\\McHal_epwm.c"
...
#line 35 "..\\Source\\Mchal\\McHal_epwm.c"
...
#line 36 "..\\Source\\Mchal\\McHal_epwm.c"
#line 1 "..\\Source\\typedef.h"
...
#line 37 "..\\Source\\Mchal\\McHal_epwm.c"
...
int32_t MH_EpwmRegInit(MH_EpwmRegConfig_t *pHandle)
{
    uint32_t epwm_ch_mask = (1UL << pHandle ->EpwmChU) | (1UL << pHandle ->EpwmChV) | (1UL << pHandle ->EpwmChW);
	...
	GPIO_SetMode(pHandle->pPortPwm, pHandle->PinPwmU | pHandle->PinPwmV | pHandle->PinPwmW, 0x1UL);
	GPIO_SetSlewCtl(pHandle->pPortPwm, pHandle->PinPwmU | pHandle->PinPwmV | pHandle->PinPwmW, 0x2UL);
	GPIO_SetPullCtl(pHandle->pPortPwm, pHandle->PinPwmU | pHandle->PinPwmV | pHandle->PinPwmW, 0x1UL);

	 
	
	EPWM_EnableLoadMode(pHandle->pInst, pHandle->EpwmChU, (1U << (0)));
	EPWM_EnableLoadMode(pHandle->pInst, pHandle->EpwmChV, (1U << (0)));
	EPWM_EnableLoadMode(pHandle->pInst, pHandle->EpwmChW, (1U << (0)));

	

 
	
	MH_EPWMSetCntType(pHandle->pInst, pHandle->EpwmChU, (2U));
	MH_EpwmSetCntMode(pHandle->pInst, pHandle->EpwmChU, 0);

    MH_EPWMSetCntType(pHandle->pInst, pHandle->EpwmChV, (2U));
    MH_EpwmSetCntMode(pHandle->pInst, pHandle->EpwmChV, 0);

    MH_EPWMSetCntType(pHandle->pInst, pHandle->EpwmChW, (2U));
    MH_EpwmSetCntMode(pHandle->pInst, pHandle->EpwmChW, 0);

    MH_EpwmSetOutMode(pHandle->pInst, epwm_ch_mask, 0);
    ...
    do{ int i; for(i = 0; i < 6; i++) { if((epwm_ch_mask) & (1 << i)) { (pHandle ->pInst)->WGCTL0 = (((pHandle ->pInst)->WGCTL0 & ~(3UL << (i << 1))) | (((1U)) << (i << 1))); (pHandle ->pInst)->WGCTL0 = (((pHandle ->pInst)->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); (pHandle ->pInst)->WGCTL1 = (((pHandle ->pInst)->WGCTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); (pHandle ->pInst)->WGCTL1 = (((pHandle ->pInst)->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((1U)) << ((16) + (i << 1)))); } } }while(0);
	...
	((pHandle ->pInst)->CLKPSC[(pHandle ->EpwmChU) >> 1] = (1));
	((pHandle ->pInst)->CLKPSC[(pHandle ->EpwmChV) >> 1] = (1));
	((pHandle ->pInst)->CLKPSC[(pHandle ->EpwmChW) >> 1] = (1));

	 
	
	
	((pHandle ->pInst)->PERIOD[(0)] = (2400));
	((pHandle ->pInst)->CMPDAT[(0)]= (1200));

	 
	
	
    ((pHandle ->pInst)->PERIOD[(2)] = (2400));
    ((pHandle ->pInst)->CMPDAT[(2)]= (1200));

	 
	
	
    ((pHandle ->pInst)->PERIOD[(4)] = (2400));
    ((pHandle ->pInst)->CMPDAT[(4)]= (1200));

	 
	
	EPWM_SetClockSource(pHandle->pInst, pHandle->EpwmChU, (0U));
    EPWM_SetClockSource(pHandle->pInst, pHandle->EpwmChV, (0U));
    EPWM_SetClockSource(pHandle->pInst, pHandle->EpwmChW, (0U));
	...
	((pHandle ->pInst)->SSCTL = ((pHandle ->pInst)->SSCTL & ~(0x3ul << (8))) | ((1U<<(8))) | (epwm_ch_mask));

	 
	
	((pHandle ->pInst)->SSTRG = (0x1ul << (0)));

	 
	
	EPWM_EnableADCTrigger(pHandle->pInst, pHandle->EpwmChU, (1U));
	...
	NVIC_SetPriority(pHandle->IrqType, NVIC_EncodePriority(3, pHandle->PreemptPrio, pHandle->SubPrio));
