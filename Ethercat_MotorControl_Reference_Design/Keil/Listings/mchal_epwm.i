...
int32_t MH_EpwmRegInit(MH_EpwmRegConfig_t *pHandle)
{
    uint32_t epwm_ch = (1UL << pHandle ->EpwmChU) | (1UL << pHandle ->EpwmChV) | (1UL << pHandle ->EpwmChW);
    ...
    MH_EpwmSetOutMode(pHandle->pInst, epwm_ch, 0);
    ...
    do{ int i; for(i = 0; i < 6; i++) { if((epwm_ch) & (1 << i)) { (pHandle ->pInst)->WGCTL0 = (((pHandle ->pInst)->WGCTL0 & ~(3UL << (i << 1))) | (((1U)) << (i << 1))); (pHandle ->pInst)->WGCTL0 = (((pHandle ->pInst)->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0U)) << ((16) + (i << 1)))); (pHandle ->pInst)->WGCTL1 = (((pHandle ->pInst)->WGCTL1 & ~(3UL << (i << 1))) | (((2U)) << (i << 1))); (pHandle ->pInst)->WGCTL1 = (((pHandle ->pInst)->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((1U)) << ((16) + (i << 1)))); } } }while(0);
	...
	((pHandle ->pInst)->SSCTL = ((pHandle ->pInst)->SSCTL & ~(0x3ul << (8))) | ((1U<<(8))) | (epwm_ch));
