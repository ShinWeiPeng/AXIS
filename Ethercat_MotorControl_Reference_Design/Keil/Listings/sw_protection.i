#line 1 "..\\Source\\McStack\\sw_protection.c"
...
#line 33 "..\\Source\\McStack\\sw_protection.c"
...
#line 34 "..\\Source\\McStack\\sw_protection.c"
...
#line 35 "..\\Source\\McStack\\sw_protection.c"
...
void MS_GetAvBusVoltage_V(MS_SwProt_Handle_t *pHandle)
{
	...
	(mapMemory[((400)+16)]) = MS_GetBusVoltage_V(pHandle->pVbusInfo);

	 
	(mapMemory[((400)+6)]) = VbusSum >> (mapMemory[(950+5)]);
	VbusSum += ((mapMemory[((400)+16)]) - (mapMemory[((400)+6)]));
}  
...
void MS_GetAvTemp_V(MS_SwProt_Handle_t *pHandle)
{
	...
	(mapMemory[((400)+17)]) = MS_GetTemp_V(pHandle->pTempInfo);

	 
	(mapMemory[((400)+7)]) = TempSum >> (mapMemory[(950+6)]);
	TempSum += ((mapMemory[((400)+17)]) - (mapMemory[((400)+7)]));
}  
...
void MS_GetAvI2T_V(MS_SwProt_Handle_t *pHandle)
{
	...
	realIq = (mapMemory[((400)+3)]);
	if (realIq < 0)
	{
		realIq =- realIq;
	}
	 
	(mapMemory[((400)+8)]) = realIqSum >> (mapMemory[(950+7)]);
	realIqSum += (realIq - (mapMemory[((400)+8)]));
	realIq = 3000 - (mapMemory[((400)+8)]);

	 
	if (realIq > 2000 || (mapMemory[((400)+7)]) < 50)
	{
		if(++CurrLmt > 1000)
		{
			realIq = 2000;
	...
	if (realIq < 1000 || (mapMemory[((400)+7)]) > 70)
	{
		if(++CurrLmt2 > 1000)
		{
			realIq = 1000;
...
void SWP_Run(MS_SwProt_Handle_t *pHandle)
{
	...
	if ((mapMemory[((240)+9)]) && !on)
	{
		on = 1;
		(mapMemory[((400)+9)]) = SAT_NO_ERR;
		(mapMemory[((420)+7)]) = 1;
		(mapMemory[((420)+8)]) = 1;
	}
	...
	if ((mapMemory[((400)+6)]) > (mapMemory[(950+0)]))
	{
		if ((++(mapMemory[(950+8)])) >= 300)
		{
			(mapMemory[((240)+9)]) = MC_DISABLE;
			(mapMemory[((400)+9)]) = SAT_OVER_VOLT;
			(mapMemory[(950+8)]) = 0;
			return;
		}
	}
	...
	if(((mapMemory[((400)+6)]) < (mapMemory[(950+1)])) && ((mapMemory[((400)+6)]) > 3))
	{
		if ((++(mapMemory[(950+8)])) >= 300)
		{
			(mapMemory[((240)+9)]) = MC_DISABLE;
			(mapMemory[((400)+9)]) = SAT_UNDER_VOLT;
			(mapMemory[(950+9)]) = 0;
			return;
		}
	}
	...
	curr = (mapMemory[((460)+13)]) - 2048;
	if ((curr > (mapMemory[(950+4)])) || (curr < (-(mapMemory[(950+4)]))))
	{
		if(++curr_count > 10)
		{
			(mapMemory[((240)+9)]) = MC_DISABLE;
			(mapMemory[((400)+9)]) = SAT_PHASE_ERR;
			curr_count = 0;
			return;
		}
	}
	...
	curr = (mapMemory[((400)+3)]);
	if ((curr > (mapMemory[(950+3)])) || (curr < (-(mapMemory[(950+3)]))))
	{
		if(++curr_count2 > 250)
		{
			(mapMemory[((240)+9)]) = MC_DISABLE;
			(mapMemory[((400)+9)]) = SAT_OVER_CURR_IQ;
			curr_count2 = 0;
			return;
		}
	}
	...
	curr = (mapMemory[((400)+2)]);
	if ((curr > (mapMemory[(950+3)])) || (curr < (-(mapMemory[(950+3)]))))
	{
		if(++curr_count3 > 250)
		{
			(mapMemory[((240)+9)]) = MC_DISABLE;
			(mapMemory[((400)+9)]) = SAT_OVER_CURR_ID;
			curr_count3 = 0;
			return;
		}
	}
	...
	if ((mapMemory[((400)+7)]) > (mapMemory[(950+2)]))
	{
		if((++(mapMemory[(950+10)])) >= 1000)
		{
			(mapMemory[((240)+9)]) = MC_DISABLE;
			(mapMemory[((400)+9)]) = SAT_OVER_TEMP;
			(mapMemory[(950+10)]) = 0;
			return;
		}
	}
...
void SWP_DriveCtrl(MS_SwProt_Handle_t *pHandle)
{
	...
	{if ((sts&0x01)?MC_ENABLE:MC_DISABLE!=0){((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL))->DOUT |= (0x00000002UL);}else{((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL))->DOUT &= (~(0x00000002UL));}};
	{if (((mapMemory[((420)+7)]))?MC_ENABLE:MC_DISABLE!=0){((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->DOUT |= (0x00000004UL);}else{((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->DOUT &= (~(0x00000004UL));}};
	{if (((mapMemory[((420)+8)]))?MC_ENABLE:MC_DISABLE!=0){((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->DOUT |= (0x00000040UL);}else{((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->DOUT &= (~(0x00000040UL));}};
