#line 1 "..\\Source\\McStack\\temp_sensor.c"
...
#line 33 "..\\Source\\McStack\\temp_sensor.c"
...
uint16_t MS_GetTemp_d(MS_Temp_Handle_t *pHandle)
{
  ...
  (mapMemory[((460)+4)]) = *(pHandle->TempRegister.ConvBuffer);

  return (mapMemory[((460)+4)]);
}  
...
uint16_t MS_GetTemp_V( MS_Temp_Handle_t * pHandle )
{
  ...
  TA = ((mapMemory[((460)+4)]) - pHandle->MCP9700V0C) / pHandle->MCP9700TC; 
