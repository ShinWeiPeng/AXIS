#line 1 "..\\Source\\Mchal\\McHal_husb.c"
...
#line 33 "..\\Source\\Mchal\\McHal_husb.c"
...
#line 34 "..\\Source\\Mchal\\McHal_husb.c"
...
#line 35 "..\\Source\\Mchal\\McHal_husb.c"
#line 36 "..\\Source\\Mchal\\McHal_husb.c"
...
{
	volatile uint32_t irq, sts;
	int i, len;
	
	irq = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->GINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->GINTEN;
	if (!irq)
	{
		return;
	}
	...
	if (irq & (0x1ul << (0)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->BUSINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->BUSINTEN;
      ...
      MH_VCP_SetupEndpoints(((((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->OPER&0x04) != 0) ? 1:0);
	...
	if  (irq & (0x1ul << (1)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->CEPINTEN;
	...
	if (irq & (0x1ul << (2)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[0ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[0ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(0ul)]. EPINTEN = (0));       
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(0ul)]. EPINTSTS = (sts));
		Husb.flgTxReady = 1;
	}
	 
	if (irq & (0x1ul << (3)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[1ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[1ul].EPINTEN;
		len = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[1ul].EPDATCNT & 0xfff;
		for (i=0; i<len; i++)
		{
			if (Husb.RxLength<16384)
			{
				Husb.RxBuffer[Husb.RxLength++] = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[1ul].EPDAT_BYTE;
			}
		}
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(1ul)]. EPINTSTS = (sts)); 
		Husb.flgRxReady=1;
	}
	 
	if (irq & (0x1ul << (4)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[2ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[2ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(2ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (5)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[3ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[3ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(3ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (6)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[4ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[4ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(4ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (7)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[5ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[5ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(5ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (8)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[6ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[6ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(6ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (9)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[7ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[7ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(7ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (10)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[8ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[8ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(8ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (11)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[9ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[9ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(9ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (12)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[10ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[10ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(10ul)]. EPINTSTS = (sts));
	}
	 
	if (irq & (0x1ul << (13)))
	{    
		sts = ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[11ul].EPINTSTS & ((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[11ul].EPINTEN;
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(11ul)]. EPINTSTS = (sts));
	}
...
static void MH_VCP_SetupEndpoints(uint32_t as_high_speed)
{
	...
	HSUSBD_SetEpBufAddr(0ul, 0x200, 1024);
	if (as_high_speed)
	{
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(0ul)]. EPMPS = (1024));
	}
	else
	{
	...
	HSUSBD_SetEpBufAddr(1ul, 0x600, 1024);
	if (as_high_speed)
	{
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(1ul)]. EPMPS = (1024));
	}
	else
	{
	...
	(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(1ul)]. EPINTEN = ((0x1ul << (4)) | (0x1ul << (12))));
	
	 
	HSUSBD_SetEpBufAddr(2ul, 0xA00, 64);
	if (as_high_speed)
	{
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(2ul)]. EPMPS = (64));
	}
	else
	{
		(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(2ul)]. EPMPS = (64));
...
{    
	...
	for (i=0; i<1024 && Husb.TxPnt<Husb.TxLength; i++)
	{
		((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[0ul].EPDAT_BYTE = Husb.TxBuffer[Husb.TxPnt++];
	}
	((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[0ul].EPRSPCTL = ((uint32_t)0x00000040ul);
	((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[0ul].EPTXCNT = i;
  Husb.flgTxReady = 0;
	(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->EP[(0ul)]. EPINTEN = ((0x1ul << (6))));
}  
...
void MH_VCP_Init(void)
{
	...
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->USBPHY =(((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->USBPHY
               & ~((0x3ul << (16)) | (0x1ul << (25))))
               |   (0x1ul << (24));
	for (i=0; i<0x1000; i++);
	...
	HSUSBD_Open(&sHSInfo, MH_VCP_ClassRequest, 0);

	(((HSUSBD_T *)(((uint32_t)0x40000000) + 0x19000UL))->GINTEN = ((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (2)) | (0x1ul << (3)) | (0x1ul << (4))));      
