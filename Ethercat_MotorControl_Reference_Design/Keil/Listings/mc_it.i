#line 1 "..\\Source\\McInterface\\mc_it.c"
...
#line 1 "..\\Source\\McInterface\\mc_it.h"
...
#line 36 "..\\Source\\McInterface\\mc_it.h"
...
#line 33 "..\\Source\\McInterface\\mc_it.c"
#line 34 "..\\Source\\McInterface\\mc_it.c"
...
#line 35 "..\\Source\\McInterface\\mc_it.c"
...
void TMR1_IRQHandler(void)
{
	TIMER_ClearIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)));
 	...
 	{if (MC_ENABLE!=0){((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->DOUT |= (0x00000001UL);}else{((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->DOUT &= (~(0x00000001UL));}};
...
void EPWM1P0_IRQHandler(void)
{
	...
	{if (MC_ENABLE!=0){((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->DOUT |= (0x00000002UL);}else{((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->DOUT &= (~(0x00000002UL));}};
