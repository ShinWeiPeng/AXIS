#line 1 "..\\Source\\McStack\\incremental_fdbk.c"
...
#line 33 "..\\Source\\McStack\\incremental_fdbk.c"
...
#line 34 "..\\Source\\McStack\\incremental_fdbk.c"
...
void MS_GetAbzCount(MS_IncremEnc_Handle_t *pHandle)
{
    ...
    {
        init = 0;
        zPhase_old = (pHandle ->QeiRegister . pInst->CNTLATCH);
    }

    (mapMemory[((400)+10)]) = (pHandle ->QeiRegister . pInst->CNT);
    zPhase_now = (pHandle ->QeiRegister . pInst->CNTLATCH);

    if (zPhase_now != zPhase_old)
    {
         
        zPhase_old = zPhase_now;
        (mapMemory[((400)+11)]) = zPhase_now;
        printf("iopIDX(Z Phase)：%d(unit: pulse)\n", (mapMemory[((400)+11)]));
