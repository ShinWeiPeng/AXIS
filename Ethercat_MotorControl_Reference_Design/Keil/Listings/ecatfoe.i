#line 1 "..\\For_SSC_Tool\\Src\\ecatfoe.c"
...
#line 54 "..\\For_SSC_Tool\\Src\\ecatfoe.c"
...
#line 58 "..\\For_SSC_Tool\\Src\\ecatfoe.c"
...
#line 156 "..\\For_SSC_Tool\\Src\\ecatfoe.h"
    ...
    unsigned long                                 u32PacketNo;  
    unsigned long                                 u32FileOffset;   
    unsigned long                                 u32LastFileOffset;  
...
#line 61 "..\\For_SSC_Tool\\Src\\ecatfoe.c"
...
#line 65 "..\\For_SSC_Tool\\Src\\ecatfoe.c"
...
unsigned char FOE_ServiceInd(TFOEMBX  * pFoeInd)
{
    ...
    case 1:
        ...
        if ( u16FileAccessState == 0 )
        {
            ...
            unsigned long u32Password = ((((unsigned long)pFoeInd->FoeHeader . Cmd . Password[0]) | ((unsigned long)pFoeInd->FoeHeader . Cmd . Password[1]) << 16));
    ...
    case 3:
          ...
          || u16FileAccessState == 6 )
        {
            ...
            unsigned long u32CmdPacketNo = ((((unsigned long)pFoeInd->FoeHeader . Cmd . PacketNo[0]) | ((unsigned long)pFoeInd->FoeHeader . Cmd . PacketNo[1]) << 16));
    ...
    case 5:
        ...
        if ( u16FileAccessState != 0 )
        {
            ...
            unsigned long u32CmdErrorCode = ((((unsigned long)pFoeInd->FoeHeader . Cmd . ErrorCode[0]) | ((unsigned long)pFoeInd->FoeHeader . Cmd . ErrorCode[1]) << 16));
