#line 1 "..\\Source\\CiA402\\cia402hm.c"
...
#line 33 "..\\Source\\CiA402\\cia402hm.c"
...
#line 34 "..\\Source\\CiA402\\cia402hm.c"
...
int32_t CIA402HM_Run(void *pAxisObj)
{
	...
	case CIA402HM_START:		
		...
		curTime = ((unsigned short)((((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x11000UL))->CNT & 0xffffful)>>6));								
		break;
	...
	case CIA402HM_RUN:
		...
		if (CIA402_CheckEmulationEnable())
		{
			if (HW_CheckTimeout(curTime, 4000))
			{
				...
				*(pCiA402->pPositionActualValue0x6064) = 0;
				...
				printd("Homing successfully done\r\n");						
			}
		}
		...
		else if (HW_CheckTimeout(curTime, 5000))
		{
			...
			CiA402_LocalError(0x7305);
			
			pCtrl->State = CIA402HM_DONE;			
			printd("Homing timeout\r\n");
		}
