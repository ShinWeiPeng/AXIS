#line 1 "..\\Source\\McStack\\curr_fdbk.c"
...
#line 33 "..\\Source\\McStack\\curr_fdbk.c"
...
MS_Curr_Handle_t MS_GetCurr_d(MS_Curr_Handle_t *pHandle)
{
	...
	(mapMemory[((460)+0)]) = ((pHandle->CurrentRegister.ConvBuffer[0]) + (pHandle->CurrentRegister.ConvBuffer[4])) >> 1;
	(mapMemory[((460)+1)]) = ((pHandle->CurrentRegister.ConvBuffer[1]) + (pHandle->CurrentRegister.ConvBuffer[3])) >> 1;
	(mapMemory[((460)+2)]) = pHandle->CurrentRegister.ConvBuffer[2];
	return (*pHandle);
}  
...
MS_Curr_Handle_t MS_GetSignedCurr_d(MS_Curr_Handle_t *pHandle)
{
	...
	avg_amp = ((mapMemory[((460)+0)]) + (mapMemory[((460)+1)]) + (mapMemory[((460)+2)])) / 3;

	 
	(mapMemory[((460)+10)]) = ((mapMemory[((460)+0)]) - (mapMemory[((460)+13)])) * (mapMemory[((460)+8)]) / 100;
	(mapMemory[((460)+11)]) = ((mapMemory[((460)+1)]) - (mapMemory[((460)+13)])) * (mapMemory[((460)+8)]) / 100;
	(mapMemory[((460)+12)]) = ((mapMemory[((460)+2)]) - (mapMemory[((460)+13)])) * (mapMemory[((460)+8)]) / 100;

	 
	com_amp = sum_amp >> 15;
	sum_amp += (avg_amp - com_amp);
	(mapMemory[((460)+13)]) = com_amp;
	return (*pHandle);
}  
