...
void MS_PiController(MS_PI_Handle_t *pHandle, int32_t type)
{
	...
	if(type == Pos)
	{
		...
		if (PosCmd_old != (mapMemory[((240)+0)]))
		{
			PosCmd_old = (mapMemory[((240)+0)]);
			MS_MapPosBlkInit();
		}
		...
		else if ((mapMemory[((240)+0)]) > LC_POS_CTRL)
		{
			(mapMemory[((300)+0)]) = (mapMemory[((240)+1)]);
		}
		else
		{
			(mapMemory[((300)+0)]) = (mapMemory[((220)+2)]);
		}
	}
	else if(type == Spd)
	{
		 
		if (SpdCmd_old != (mapMemory[((240)+0)]))
		{
			SpdCmd_old = (mapMemory[((240)+0)]);
			MS_MapSpdBlkInit();
		}
		...
		{
			(mapMemory[((320)+0)]) = (mapMemory[((300)+3)]);
		}
		else if ((mapMemory[((240)+0)]) > LC_SPD_CTRL)
		{
			(mapMemory[((320)+0)]) = (mapMemory[((220)+3)]) + (mapMemory[((300)+3)]);
		}
		else
		{
			(mapMemory[((320)+0)]) = (mapMemory[((220)+3)]);
		}
	}
	else if(type == Amp)
	{
		if (++AmpCmdCnt >= 20)
		{
			...
			if (AmpCmd_old != (mapMemory[((240)+0)]))
			{
				AmpCmd_old = (mapMemory[((240)+0)]);
				MS_MapAmpBlkInit();
			}
			...
			else if ((mapMemory[((240)+0)]) < LC_PP_CTRL)
			{
				(mapMemory[((240)+4)]) = (mapMemory[((220)+4)]);
			}

			if ((mapMemory[((240)+0)]) > LC_AMP_CTRL)
			{
				(mapMemory[((340)+0)]) = (mapMemory[((240)+4)]) + (mapMemory[((320)+3)]);
			}
			else
			{
				(mapMemory[((340)+0)]) = (mapMemory[((240)+4)]);
			}

			 
			if ((mapMemory[((340)+0)]) > (mapMemory[((340)+3)]))
			{
				(mapMemory[((340)+0)]) = (mapMemory[((340)+3)]);
			}
