#line 1 "..\\Source\\McStack\\trajectory_ctrl.c"
...
#line 33 "..\\Source\\McStack\\trajectory_ctrl.c"
...
int TC_SpeedCurveGenerator(TC_MODE_E mode)
{
	...
	if (mode == TCM_START)
	{
		acc = (mapMemory[((260)+3)])*1000/(mapMemory[((260)+4)]);
		dec = (mapMemory[((260)+3)])*1000/(mapMemory[((260)+5)]);
		dec2 = dec*2;

		 
		if ((mapMemory[((260)+2)]) <= 0)
		{
			vel = (mapMemory[((260)+3)])*10;
		}
		else if ((mapMemory[((260)+2)]) > (mapMemory[((260)+3)]))
		{
			vel = (mapMemory[((260)+3)])*1000;
		}
		else
		{
			vel = (mapMemory[((260)+2)])*1000;
		}

		if ((mapMemory[((260)+1)]) > (mapMemory[((240)+1)]))
		{
			 
			dir = TCD_FORWARD;
			(mapMemory[((260)+6)]) = TCS_ADJ_SPD;
		}
		else if ((mapMemory[((260)+1)]) < (mapMemory[((240)+1)]))
		{
	...
	{
		if ((mapMemory[((260)+6)]) > TCS_DEC_SPD)
		{
			spd = 0;
		}
		return (spd/1000);
  ...
  dst = (mapMemory[((260)+1)]) - (mapMemory[((240)+1)]);
	d = (mapMemory[((240)+2)])*(mapMemory[((240)+2)])/dec2;

	switch ((mapMemory[((260)+6)]))
	{
	case TCS_ADJ_SPD:
		
		if ((dir*spd) >= 0 && (dir*spd) <= vel)
		{
			(mapMemory[((260)+6)]) = TCS_ACC_SPD;
		}
		break;
	...
	case TCS_ACC_SPD:
		...
		if ((dir*dst) <= d)
		{
			(mapMemory[((260)+6)]) = TCS_DEC_SPD;
			break;
		}

		
		if ((dir*(mapMemory[((240)+2)])) >= (mapMemory[((260)+2)]))
		{
			(mapMemory[((260)+6)]) = TCS_CONST_SPD;
		}
		break;
...
void TC_Init(void)
{
	(mapMemory[((240)+1)]) = (mapMemory[((400)+0)]);    
	(mapMemory[((260)+1)]) = (mapMemory[((400)+0)]);    
	(mapMemory[((260)+0)]) = TCC_NO_CMD;
	(mapMemory[((260)+6)]) = TCS_STOP;  
	printf("TC_Init: cmdPOS=segPOS=iopANG=%d\r\n", (mapMemory[((260)+1)]));
}  
...
void TC_Run(void)
{
	...
	if (old != (mapMemory[((240)+0)]))
  {
	...
	if ((mapMemory[((240)+0)]) < LC_PP_CTRL)
	{
		return;
	}

	 
	if ((mapMemory[((260)+0)]) > TCC_NO_CMD)
	{
		if ((mapMemory[((260)+0)]) == TCC_ABS_POS)
		{
			(mapMemory[((260)+1)]) = (mapMemory[((220)+2)]);
		}
		else if ((mapMemory[((260)+0)]) == TCC_REL_POS)
		{
			(mapMemory[((260)+1)]) = (mapMemory[((240)+1)]) + (mapMemory[((220)+2)]);
		}
		else if ((mapMemory[((260)+0)]) == TCC_BRAKE)
		{
			(mapMemory[((260)+1)]) = (mapMemory[((240)+1)]);
		}
		(mapMemory[((260)+0)]) = TCC_NO_CMD;
		if ((mapMemory[((260)+1)]) != (mapMemory[((240)+1)]))
		{
			(mapMemory[((260)+2)]) = ((mapMemory[((220)+3)]) < 0) ? (-(mapMemory[((220)+3)])):(mapMemory[((220)+3)]);
			if ((mapMemory[((260)+2)]))
			{
	...
	if ((mapMemory[((260)+2)]))
	{
		...
		(mapMemory[((240)+3)]) = TC_SpeedCurveGenerator(TCM_RUN);
		(mapMemory[((240)+2)]) = TC_SpeedCurveGenerator(TCM_GET_SPD);
		(mapMemory[((240)+1)]) += (mapMemory[((240)+2)]);
	}
	else
	{
		(mapMemory[((240)+1)]) = (mapMemory[((260)+1)]);
	}
}  
