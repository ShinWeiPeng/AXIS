#line 1 "..\\Source\\Mchal\\McHal_gpio.c"
...
#line 33 "..\\Source\\Mchal\\McHal_gpio.c"
...
#line 34 "..\\Source\\Mchal\\McHal_gpio.c"
...
int32_t MH_SwProtRegInit(MH_SwProtRegConfig_t *pHandle)
{
	...
	GPIO_SetMode(pHandle->pPortGateDriveEnb, pHandle->PinGateDriveEnb, 0x1UL);	
	GPIO_SetSlewCtl(pHandle->pPortGateDriveEnb, pHandle->PinGateDriveEnb, 0x2UL);
	GPIO_SetPullCtl(pHandle->pPortGateDriveEnb, pHandle->PinGateDriveEnb, 0x0UL);
	{if (MC_DISABLE!=0){pHandle ->pPortGateDriveEnb->DOUT |= pHandle ->PinGateDriveEnb;}else{pHandle ->pPortGateDriveEnb->DOUT &= (~pHandle ->PinGateDriveEnb);}};          
	
	 
	MH_SetMFP(pHandle->pPortPwmWdtTrg, pHandle->PinPwmWdtTrg, 0);
	GPIO_SetMode(pHandle->pPortPwmWdtTrg, pHandle->PinPwmWdtTrg, 0x1UL);
	GPIO_SetSlewCtl(pHandle->pPortPwmWdtTrg, pHandle->PinPwmWdtTrg, 0x2UL);
	GPIO_SetPullCtl(pHandle->pPortPwmWdtTrg, pHandle->PinPwmWdtTrg, 0x0UL);
	{if (MC_DISABLE!=0){pHandle ->pPortPwmWdtTrg->DOUT |= pHandle ->PinPwmWdtTrg;}else{pHandle ->pPortPwmWdtTrg->DOUT &= (~pHandle ->PinPwmWdtTrg);}};          
	
	 	
	MH_SetMFP(pHandle->pPortMotorBrake, pHandle->PinMotorBrake, 0);
	GPIO_SetMode(pHandle->pPortMotorBrake, pHandle->PinMotorBrake, 0x1UL);	
	GPIO_SetSlewCtl(pHandle->pPortMotorBrake, pHandle->PinMotorBrake, 0x2UL);
	GPIO_SetPullCtl(pHandle->pPortMotorBrake, pHandle->PinMotorBrake, 0x0UL);
	{if (MC_DISABLE!=0){pHandle ->pPortMotorBrake ->DOUT |= pHandle ->PinMotorBrake;}else{pHandle ->pPortMotorBrake ->DOUT &= (~pHandle ->PinMotorBrake);}};          
...
void MH_DebugHwInit(void)
{
	...
	MH_SetMFP(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00000002UL), 0);
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00000002UL), 0x1UL);
	GPIO_SetSlewCtl(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00000002UL), 0x2UL);
	GPIO_SetPullCtl(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00000002UL), 0x1UL);
	{if (MC_DISABLE!=0){((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->DOUT |= (0x00000002UL);}else{((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->DOUT &= (~(0x00000002UL));}};
	
	MH_SetMFP(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000001UL), 0);
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000001UL), 0x1UL);
	GPIO_SetSlewCtl(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000001UL), 0x2UL);
	GPIO_SetPullCtl(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)), (0x00000001UL), 0x1UL);
	{if (MC_DISABLE!=0){((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->DOUT |= (0x00000001UL);}else{((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->DOUT &= (~(0x00000001UL));}};	
