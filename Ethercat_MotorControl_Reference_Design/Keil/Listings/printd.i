...
static short printd_PutString(char *strData, short len)
{
    ...
    while (len-- >0)
    {
        AX_UART_PutChar(*(unsigned char*)(pStr));
        pStr++;
    }
    return 1;	
}  
