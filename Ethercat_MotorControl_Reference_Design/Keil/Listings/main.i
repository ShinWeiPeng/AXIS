...
int main()
{
	...
	printf("%s_Firmware v%s, %s \n", "AX58200_MotorControl", "2.0.0", "May 31 2022");

	 
	MC_Init();
	printf("MC Stack Info: sysVERS=%u, sysDATE=%u, romVERS=%u, romDATE=%u\r\n", (mapMemory[1020]), (mapMemory[1021]), (mapMemory[1022]), (mapMemory[1023]));
...
void SysInit(void)
{
	...
	CLK_EnableSysTick((0x0UL << (3)), (CLK_GetHXTFreq() / 1000)); 
