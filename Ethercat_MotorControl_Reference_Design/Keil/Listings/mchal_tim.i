#line 1 "..\\Source\\Mchal\\McHal_tim.c"
...
#line 33 "..\\Source\\Mchal\\McHal_tim.c"
...
#line 34 "..\\Source\\Mchal\\McHal_tim.c"
...
{	 
	...
	MH_TmrClkSource(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)), MC_ENABLE);
	
	 
	TIMER_DisableInt(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)));
	...
	NVIC_SetPriority(TMR1_IRQn, NVIC_EncodePriority(3, 5, 0));
