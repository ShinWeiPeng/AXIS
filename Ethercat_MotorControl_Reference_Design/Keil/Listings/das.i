...
DAS_STATE_E DAS_Run(void)
{
	...
	DAS_STATE_E cur_ste;
	int i, *pBuf, *pVarInd = &(mapMemory[((200)+11)]);
	...
	default:
	case DASSTE_IDLE:
		if ((mapMemory[((200)+1)]) == DASSTE_START)
		{
			 
			if ((mapMemory[((200)+10)]) < 1)
			{
				(mapMemory[((200)+10)]) = 1;
			}
			else if ((mapMemory[((200)+10)]) > 9)
			{
				(mapMemory[((200)+10)]) = 9;
			}

			 
			if ((mapMemory[((200)+2)]) < 1)
			{
				(mapMemory[((200)+2)]) = 1;
			}
			else if ((mapMemory[((200)+2)]) > 1000)
			{
				(mapMemory[((200)+2)]) = 1000;
			}

			 
			for (i=0, pVarInd=&(mapMemory[((200)+11)]); i<(mapMemory[((200)+10)]); i++, pVarInd++)
			{
				if (*pVarInd<0 || *pVarInd>=1600)
				{
					 
					(mapMemory[((200)+1)]) = DASSTE_IDLE;
					break;
				}
			}

			 
			(mapMemory[((200)+4)]) = (mapMemory[((200)+5)])/(mapMemory[((200)+10)]);
			(mapMemory[((200)+0)]) = 0;
			 
			ste = DASSTE_RUN;
			(mapMemory[((200)+1)]) = ste;
			 
			(mapMemory[((200)+3)]) = (mapMemory[((200)+2)]);
		}
		else
		{
			break;
	...
	case DASSTE_RUN:
		...
		if ((mapMemory[((200)+1)]) <= DASSTE_IDLE)
		{
			ste = DASSTE_IDLE;
			break;
		}
		...
		if ((mapMemory[((200)+0)]) >= (mapMemory[((200)+4)]))
		{
			ste = DASSTE_IDLE;
			(mapMemory[((200)+1)]) = ste;
			break;
		...
		pVarInd = &(mapMemory[((200)+11)]);
		pBuf = &dasMemory[(mapMemory[((200)+0)])*(mapMemory[((200)+10)])];
		(mapMemory[((200)+0)])++;
		for (i=0; i<(mapMemory[((200)+10)]); i++)
		{
