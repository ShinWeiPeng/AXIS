...
#line 33 "..\\Source\\Debug\\console.c"
#line 34 "..\\Source\\Debug\\console.c"
...
#line 35 "..\\Source\\Debug\\console.c"
...
#line 36 "..\\Source\\Debug\\console.c"
...
#line 37 "..\\Source\\Debug\\console.c"
...
#line 38 "..\\Source\\Debug\\console.c"
...
#line 39 "..\\Source\\Debug\\console.c"
...
#line 40 "..\\Source\\Debug\\console.c"




 
#line 57 "..\\Source\\Debug\\console.c"

#line 70 "..\\Source\\Debug\\console.c"
...
static CONSOLE_Inst console_Instance[1];
...
short CONSOLE_ChangeUsername(CONSOLE_Inst *pInst, unsigned char *username)
{
    ...
    for (i=0, account=&CLICMD_userTable[0]; i < 1; i++, account++)
    {
...
#line 283 "..\\Source\\Debug\\console.c"
...
static short console_CommandProcess(CONSOLE_Inst *pInst, char *pLine, unsigned char privilege)
{
    ...
    if (!strncmp(pLine, "help", strlen("help")))
    {
        console_HelpMessage(pInst, privilege);
        return 1;
    }
#line 358 "..\\Source\\Debug\\console.c"
...
static short console_CollectCommand(CONSOLE_Inst *pInst, char buf[], short size, short echo)
{
    ...
    switch (c)
    {
        ...
        case 0x7F:
            ...
            if(echo)
                console_PutString(pInst, "\010 \010", strlen("\010 \010"));
        ...
        case '\n':
#line 492 "..\\Source\\Debug\\console.c"
                return 0;
        default:
	            if ( c < 0x20 || c >= 0x80)  
                return 0;
...
static unsigned char console_AddCommandHistory(CONSOLE_Inst *pInst, char buf[])
{
	...
	if (tmp != 10)
	{
		pInst->CmdHistory.GetIndex = tmp ? (tmp-1):(10-1);
		return 0;
	}
	...
	pInst->CmdHistory.GetIndex = i ? (i-1):(10-1);
...
#line 764 "..\\Source\\Debug\\console.c"
...
#line 883 "..\\Source\\Debug\\console.c"
                break;
            case CLI_STATE_PASSWD:
                if (pInst->PromptEnable == 1)
                {
                    CONSOLE_PutMessage(pInst, "%s", "password: ");
                    memset(pInst->Passwd, 0, 16);
                    pInst->PromptEnable = 0;
                    pInst->BufIndex = 0;
                    pInst->CursorPosition = pInst->BufIndex;
                }
                retCode = console_CollectCommand(pInst, pInst->Passwd, 16, 0);
                if (retCode == 10)
                {
                    pInst->PromptEnable = 1;
                ...
                {
                    pInst->PromptEnable = 1;
#line 922 "..\\Source\\Debug\\console.c"
                        pInst->State = CLI_STATE_LOGIN;
                }
                break;
            case CLI_STATE_COMMAND:
                ...
                retCode = console_CollectCommand(pInst, pInst->CmdBuf, 512, 1);
                if (retCode == 10)
                {
                    pInst->PromptEnable = 1;
                    if (console_CommandProcess(pInst, pInst->CmdBuf, pInst->Privilege) < 0)
                    {
#line 950 "..\\Source\\Debug\\console.c"
                        {
                            pInst->State = CLI_STATE_LOGIN;
                        }
                    }
                ...
                {
                    pInst->PromptEnable = 1;
#line 967 "..\\Source\\Debug\\console.c"
                        pInst->State = CLI_STATE_LOGIN;
                }
                break;
            ...
            case CLI_STATE_PASSWD_CHANGE2:
                if (pInst->PromptEnable == 1)
                {
                    ...
                    memset(pInst->PasswdNew, 0, 16);
                    pInst->PromptEnable = 0;
                    pInst->BufIndex = 0;
                    pInst->CursorPosition = pInst->BufIndex;
                }
                retCode = console_CollectCommand(pInst, pInst->PasswdNew, 16, 0);
                if (retCode == 10)
                {
                    pInst->PromptEnable = 1;
            ...
            case CLI_STATE_PASSWD_CHANGE3:
                if (pInst->PromptEnable == 1)
                {
                    ...
                    memset(pInst->CmdBuf, 0, 16);
                    pInst->PromptEnable = 0;
                    pInst->BufIndex = 0;
                    pInst->CursorPosition = pInst->BufIndex;
                }
                retCode = console_CollectCommand(pInst, pInst->CmdBuf, 16, 0);
                if (retCode == 10)
                {
                    pInst->PromptEnable = 1;
