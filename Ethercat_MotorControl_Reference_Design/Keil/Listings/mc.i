#line 1 "..\\Source\\McInterface\\mc.c"
...
#line 33 "..\\Source\\McInterface\\mc.c"
...
#line 34 "..\\Source\\McInterface\\mc.c"
...
#line 35 "..\\Source\\McInterface\\mc.c"
#line 1 "..\\Source\\Mchal\\McHal_tim.h"
...
#line 36 "..\\Source\\Mchal\\McHal_tim.h"
...
#line 36 "..\\Source\\McInterface\\mc.c"
#line 37 "..\\Source\\McInterface\\mc.c"
...
MI_Vbus_Handle_t BusVoltageParamsM1 =
{
	.VbusInfo =
	{
		...
		.VbusRegister =
		{
			.pInst = ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)),
			.pPort = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),
			.Channel = (0x00000001UL),
			.IrqType = EADC00_IRQn,
			.MultiFuncValue = 1,
			.SampleModuleMask = 5,
		},
...
MI_Temp_Handle_t TemperatureParamsM1 =
{
	.TempInfo =
	{
		.TempRegister =
		{
			.pInst = ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)),
			.pPort = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),
			.Channel = (0x00000080UL),
			.IrqType = EADC00_IRQn,
			.MultiFuncValue = 1,
			.SampleModuleMask = 6,
		},
		.MCP9700V0C = (1<<12) * 500 / 3300,
		.MCP9700TC = (1<<12) * 10 / 3300,
		.ChannelNum = 1,
	},
};
...
MI_Curr_Handle_t CurrentParamsM1 =
{
	.CurrInfo =
	{
		.CurrentRegister =
		{
			...
			.pPort[0] = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),
			.Channel[0] = (0x00001000UL),
			.SampleModuleMask[0] = 0,

			 
			.pPort[1] = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),
			.Channel[1] = (0x00002000UL),
			.SampleModuleMask[1] = 1,

			 
			.pPort[2] = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),
			.Channel[2] = (0x00004000UL),
			.SampleModuleMask[2] = 2,

			 
			.pPort[3] = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),
			.Channel[3] = (0x00002000UL),
			.SampleModuleMask[3] = 3,

			 
			.pPort[4] = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),
			.Channel[4] = (0x00001000UL),
...
MI_IncremEnc_Handle_t IncremEncParamsM1 =
{
	.IncremEncInfo = {
		.QeiRegister = {
			.pInst = ((QEI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x70000UL)),
			.pPortIncEnc = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL)),
			.PinA = (0x00000010UL),
			.PinB = (0x00000008UL),
			.PinZ = (0x00000020UL),

			.pPortWireCtrl = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)),
			.PinWireCtrl = (0x00000010UL),
			.MultiFuncValue = 14,
		},
	},
};
...
MI_Pwm_Handle_t PwmParamsM1 = {
	.PwmInfo = {
		.EpwmRegister = {
			.pInst = ((EPWM_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x19000UL)),
			.IrqType = EPWM1P0_IRQn,
			.PreemptPrio = 1,
			.SubPrio = 0,
			.pPortPwm = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)),
			.PinPwmU = (0x00000020UL),
			.PinPwmV = (0x00000008UL),
			.PinPwmW = (0x00000002UL),
			.MultiFuncValue = 12,
			.EpwmChU = 0,
			.EpwmChV = 2,
			.EpwmChW = 4,
...
MI_SwProt_Handle_t SwProtParamsM1 = {
	.SwProtInfo = {
		.SwProtRegister = {
			.pPortGateDriveEnb = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL)),
			.PinGateDriveEnb = (0x00000004UL),
			.pPortPwmWdtTrg = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04100UL)),
			.PinPwmWdtTrg = (0x00000002UL),
			.pPortMotorBrake = ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)),
			.PinMotorBrake = (0x00000040UL),
		},
...
MI_Pi_Handle_t PosParamsM1 = {
	.PiInfo = {
		.Cmd = &(mapMemory[((300)+0)]),
		.Feedback = &(mapMemory[((400)+0)]),
		.Kp = &(mapMemory[((300)+7)]),
		.Ki = &(mapMemory[((300)+8)]),
		.KpDiv = 100,
		.KiDiv = 10000,
		.Error = &(mapMemory[((300)+1)]),
		.Integraler = &(mapMemory[((300)+2)]),
		.ErrorLimit = &(mapMemory[((300)+4)]),
		.IntegralLimit = &(mapMemory[((300)+5)]),
		.OutputLimit = &(mapMemory[((300)+6)]),
		.Division = &(mapMemory[((300)+9)]),
		.Output = &(mapMemory[((300)+3)]),
	},
};
...
MI_Pi_Handle_t SpdParamsM1 = {
	.PiInfo = {
		.Cmd = &(mapMemory[((320)+0)]),
		.Feedback = &(mapMemory[((400)+1)]),
		.Kp = &(mapMemory[((320)+7)]),
		.Ki = &(mapMemory[((320)+8)]),
		.KpDiv = 100,
		.KiDiv = 10000,
		.Error = &(mapMemory[((320)+1)]),
		.Integraler = &(mapMemory[((320)+2)]),
		.ErrorLimit = &(mapMemory[((320)+4)]),
		.IntegralLimit = &(mapMemory[((320)+5)]),
		.OutputLimit = &(mapMemory[((320)+6)]),
		.Division = &(mapMemory[((320)+10)]),
		.Output = &(mapMemory[((320)+3)]),
	},
};
...
MI_Pi_Handle_t AmpParamsM1 = {
	.PiInfo = {
		.Cmd = &(mapMemory[((340)+0)]),
		.Feedback = &(mapMemory[((400)+3)]),
		.Kp = &(mapMemory[((340)+7)]),
		.Ki = &(mapMemory[((340)+8)]),
		.KpDiv = 100,
		.KiDiv = 200000,
		.Error = &(mapMemory[((340)+14)]),
		.Integraler = &(mapMemory[((340)+2)]),
		.ErrorLimit = &(mapMemory[((340)+4)]),
		.IntegralLimit = &(mapMemory[((340)+5)]),
		.OutputLimit = &(mapMemory[((340)+6)]),
		.Division = &(mapMemory[((340)+16)]),
		.Output = &(mapMemory[((400)+5)]),
	},
};
...
MI_Pi_Handle_t AmpParamsM2 = {
	.PiInfo = {
		.Cmd = &ampIdCmd,
		.Feedback = &(mapMemory[((400)+2)]),
		.Kp = &(mapMemory[((340)+7)]),
		.Ki = &(mapMemory[((340)+8)]),
		.KpDiv = 100,
		.KiDiv = 200000,
		.Error = &(mapMemory[((340)+15)]),
		.Integraler = &(mapMemory[((340)+1)]),
		.ErrorLimit = &(mapMemory[((340)+4)]),
		.IntegralLimit = &(mapMemory[((340)+5)]),
		.OutputLimit = &(mapMemory[((340)+6)]),
		.Division = &(mapMemory[((340)+16)]),
		.Output = &(mapMemory[((400)+4)]),
	},
};
...
void MC_TickRun(void)
{
	...
	(mapMemory[1000])++;
	if ((mapMemory[1009]) > 0 && (mapMemory[1009]) < 999999)
	{
		(mapMemory[1009])++;
	}
...
MC_STATE_E MC_TaskRun(void)
{
	...
	if((mapMemory[((240)+0)]) >= LC_POS_CTRL)
	{
		MS_PiController(&PosParamsM1.PiInfo,Pos);
	}

	if((mapMemory[((240)+0)]) >= LC_SPD_CTRL)
	{
		MS_PiController(&SpdParamsM1.PiInfo,Spd);
	}

	 
	(mapMemory[((220)+6)]) = (mapMemory[((400)+0)]);
	(mapMemory[((220)+7)]) = (mapMemory[((400)+1)]);
	(mapMemory[((220)+8)]) = (mapMemory[((400)+3)]);
	(mapMemory[((220)+9)]) = (mapMemory[((320)+3)]);

	if ((mapMemory[((400)+9)]) != SAT_NO_ERR)
	{
		if ((mapMemory[((400)+9)]) == SAT_OVER_VOLT)
		{
			pMc->FaultFlags |= MCFS_OVER_VOLT;
		}
		if ((mapMemory[((400)+9)]) == SAT_UNDER_VOLT)
		{
			pMc->FaultFlags |= MCFS_UNDER_VOLT;
		}
		if ((mapMemory[((400)+9)]) == SAT_OVER_TEMP)
		{
			pMc->FaultFlags |= MCFS_OVER_TEMP;
		}
		if ((mapMemory[((400)+9)]) == SAT_PHASE_ERR)
		{
			pMc->FaultFlags |= MCFS_PHASE_ERR;
		}
		if ((mapMemory[((400)+9)]) == SAT_OVER_CURR_ID || (mapMemory[((400)+9)]) == SAT_OVER_CURR_IQ)
		{
	...
	case MCSTE_START_ENC_ALIGN:
		...
		pMc->HomingReach = 0;
		(mapMemory[((260)+0)]) = TCC_ABS_POS;
		(mapMemory[((220)+2)]) = (mapMemory[((400)+0)]) + ((mapMemory[((480)+4)])*11/10);
		(mapMemory[((220)+3)]) = pMc->HomingVelocity;
	...
	case MCSTE_ENC_ALIGN:
		...
		else if ((IncremEncParamsM1.IncremEncInfo.AlignRequest == 0) && ((mapMemory[((260)+0)]) == TCC_NO_CMD))
		{
    ...
    (mapMemory[((220)+4)]) = 0;
    (mapMemory[((220)+5)]) = 1000;
		(mapMemory[((240)+9)]) = MC_ENABLE;
		(mapMemory[((440)+3)]) = SCM_AUTO_CTRL;
    (mapMemory[((220)+2)]) = (mapMemory[((400)+0)]);
		(mapMemory[((220)+3)]) = pMc->VelocityCmd;
		(mapMemory[((240)+0)]) = LC_PP_CTRL;
	...
	case MCSTE_RUN:
		...
		{
			(mapMemory[((260)+0)]) = TCC_ABS_POS;
			(mapMemory[((220)+2)]) = pMc->PositionCmd;
			(mapMemory[((220)+3)]) = pMc->VelocityCmd;
			pMc->Cmd = MCCMD_NO_CMD;
		}
	...
	case MCSTE_SHUTDOWN:
		...
		(mapMemory[((240)+9)]) = MC_DISABLE;
		(mapMemory[((420)+7)]) = MC_DISABLE;
		(mapMemory[((440)+3)]) = SCM_DISABLE;
		(mapMemory[((240)+0)]) = LC_ALL_OFF;
	...
	case MCSTE_FAULT:
		...
		printf("Enter fault state: FaultFlags=0x%08x, iopALM=%d\r\n", pMc->FaultFlags, (mapMemory[((400)+9)]));
		break;
	...
	case MCSTE_WAIT_CLR_ERR:
		...
		if (pMc->Cmd == MCCMD_FAULT_RESET)
		{
			pMc->Cmd = MCCMD_NO_CMD;
			(mapMemory[((400)+9)]) = 0;
			pMc->FaultFlags = MCFS_NO_ERR;
			pMc->State = MCSTE_IDLE;
			printf("Fault Reset OK!\r\n");
		}
		break;
	}
...
void MC_ClearActualPosition(void)
{
	...
	(mapMemory[((240)+1)]) = 0;
	(mapMemory[((260)+1)]) = 0;
	(mapMemory[((260)+0)]) = TCC_NO_CMD;
	(mapMemory[((260)+6)]) = TCS_STOP;
