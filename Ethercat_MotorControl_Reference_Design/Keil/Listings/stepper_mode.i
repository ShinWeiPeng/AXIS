#line 1 "..\\Source\\McStack\\stepper_mode.c"
...
#line 33 "..\\Source\\McStack\\stepper_mode.c"
...
#line 34 "..\\Source\\McStack\\stepper_mode.c"
...
#line 35 "..\\Source\\McStack\\stepper_mode.c"
...
#line 36 "..\\Source\\McStack\\stepper_mode.c"
...
STPM_STATE_E STPM_RunStepping(STPM_CTRL_T *pStpMod)
{
	...
	if (pStpMod->State!=STPM_IDLE && (mapMemory[((420)+7)])==MC_DISABLE)
	{
	...
	case STPM_IDLE:
		...
		if ((mapMemory[((420)+12)])==0 && (mapMemory[((420)+4)])!=0 && (mapMemory[((240)+6)])==MC_DISABLE)
		{
			 
			(mapMemory[((240)+0)]) = LC_ALL_OFF;
			(mapMemory[((440)+3)]) = SCM_DISABLE;
			(mapMemory[((420)+7)]) = MC_ENABLE;
	...
	case STPM_START:
		...
		if ((mapMemory[((420)+5)]) < 0)
		{
			 
			pStpMod->IsSingleTurn = 1;
			pStpMod->State = ((mapMemory[((420)+6)]) > 0) ? STPM_FORWARD:STPM_BACKWARD;
			(mapMemory[((420)+5)]) = -(mapMemory[((420)+5)]);
			(mapMemory[((420)+6)]) = 360;
		}
		else
		{
			...
			if ((mapMemory[((420)+6)]) < 0)
			{
				(mapMemory[((420)+6)]) = -(mapMemory[((420)+6)]);
			}
		}
		(mapMemory[((420)+3)]) = 0;
		pStpMod->StpAng = 1;
		...
		(mapMemory[((400)+5)]) = 0;
		(mapMemory[((400)+4)]) = (mapMemory[((420)+4)]);
		(mapMemory[((440)+3)]) = SCM_MANUAL_CTRL;

		pStpMod->TickMs[0] = (mapMemory[((420)+5)]);
		break;
	...
	case STPM_FORWARD:
		...
		if ((mapMemory[((420)+3)]) < (mapMemory[((420)+6)]))
		{
			(mapMemory[((420)+3)]) += pStpMod->StpAng;
		}
		else
		{
			pStpMod->State = (pStpMod->IsSingleTurn!=0) ? STPM_DONE:STPM_BACKWARD;
		}

		 
		if ((mapMemory[((420)+4)]) == 0)
		{
	...
	case STPM_BACKWARD:
		...
		{
			pStpMod->State = (pStpMod->IsSingleTurn!=0) ? STPM_DONE:STPM_FORWARD;
		}
	...
	case STPM_ZERO_VECTOR:
		...
		if ((mapMemory[((420)+3)]) > pStpMod->StpAng)
		{
			(mapMemory[((420)+3)]) -= pStpMod->StpAng;
		}
		else if ((mapMemory[((420)+3)]) < -pStpMod->StpAng)
		{
			(mapMemory[((420)+3)]) += pStpMod->StpAng;
		}
		else if ((mapMemory[((420)+3)]) > 0)
		{
			(mapMemory[((420)+3)])--;
		}
		else if ((mapMemory[((420)+3)]) < 0)
...
STPM_VECALI_STATE_E STPM_VectorAlignment(STPM_CTRL_T *pStpMod)
{
	...
	if (pStpMod->VecAliState!=STPMVA_IDLE && (mapMemory[((420)+7)])==MC_DISABLE)
	{
		pStpMod->TickMs[0] = 0;
	...
	case STPMVA_IDLE:
		...
		if ((mapMemory[((420)+4)])==0 && (mapMemory[((420)+12)])!=0 && (mapMemory[((240)+6)])==MC_DISABLE)
		{
	...
	case STPMVA_START:
		...
		(mapMemory[((420)+3)]) = 0;
		(mapMemory[((400)+5)]) = 0;
		(mapMemory[((400)+4)]) = (mapMemory[((420)+12)]);

		pStpMod->TickMs[0] = 3000;
		pStpMod->TickMs[1] = 10;
		pStpMod->RotorStableCnt = 10;
		pStpMod->RotorAngT[1] = (mapMemory[((440)+0)]);
	...
	case STPMVA_WAIT_ALIGN:
		...
		pStpMod->RotorAngT[0] = (mapMemory[((440)+0)]);
		...
		if (pStpMod->RotorStableCnt == 0)
		{
			...
			pStpMod->RotorAngT[0] = pStpMod->RotorAngT[1] - (mapMemory[((420)+3)]);
			...
			(mapMemory[((440)+6)]) = pStpMod->RotorAngT[0];
			printf("Vector alignment done, uvwDEG0(%d)=uvwDEG(%d)-pwmDEG(%d)\r\n", (mapMemory[((440)+6)]), pStpMod->RotorAngT[1], (mapMemory[((420)+3)]));
			pStpMod->VecAliState = STPMVA_DONE;
			pStpMod->TickMs[0] = 10;
			break;
		}
		...
		{
			printf("Fail to wait rotor stable, rotor_ang_t[1]=%d, rotor_ang_t[0]=%d\r\n", pStpMod->RotorAngT[1], pStpMod->RotorAngT[0]);
	...
	case STPMVA_FAIL:
		...
		(mapMemory[((400)+4)]) = 0;
		(mapMemory[((420)+12)]) = 0;
		pStpMod->VecAliState = STPMVA_IDLE;
		break;
	}
