#line 1 "..\\Source\\McStack\\bus_vol_sensor.c"
...
#line 33 "..\\Source\\McStack\\bus_vol_sensor.c"
...
int32_t MS_GetBusVoltage_d(MS_Vbus_Handle_t *pHandle)
{
  ...
  (mapMemory[((460)+3)]) = *(pHandle->VbusRegister.ConvBuffer);

  return (mapMemory[((460)+3)]);
}  
...
uint16_t MS_GetBusVoltage_V(MS_Vbus_Handle_t *pHandle)
{
  ...
  temp = ((mapMemory[((460)+3)]) * (pHandle->ConversionFactor)) >> 12;
