#line 1 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.c"
...
#line 50 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.c"
...
#line 51 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.c"
#line 1 "..\\For_SSC_Tool\\Src\\ecatfoe.h"
...
#line 34 "..\\For_SSC_Tool\\Src\\ecatfoe.h"
...
#line 35 "..\\For_SSC_Tool\\Src\\ecatfoe.h"
...
#line 56 "..\\For_SSC_Tool\\Src\\ecatfoe.h"




 
#line 68 "..\\For_SSC_Tool\\Src\\ecatfoe.h"
...
{
    unsigned short    Cmd;
#line 86 "..\\For_SSC_Tool\\Src\\ecatfoe.h"
    unsigned short    Size;
    unsigned long    Address;
    unsigned short      Data[512>>1];
}
TEFWUPDATE;
...
typedef struct 
{
    ...
    unsigned short              Data[(((0x0080 - 6))-(sizeof(TFOEHEADER))) >> 1];  
}
TFOEMBX;
...
#line 156 "..\\For_SSC_Tool\\Src\\ecatfoe.h"
...
extern    unsigned long                                 u32PacketNo;  
extern    unsigned long                                 u32FileOffset;   
extern    unsigned long                                 u32LastFileOffset;  
...
#line 52 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.c"
...
#line 59 "..\\For_SSC_Tool\\Src\\foeappl.h"
    ...
    unsigned short     FOE_Read(unsigned short  * pName, unsigned short nameSize, unsigned short  * pData, unsigned long password);
    unsigned short     FOE_Write(unsigned short  * pName, unsigned short nameSize, unsigned long password);
    unsigned short     FOE_Data(unsigned short  * pData, unsigned short Size);
    unsigned short     FOE_Ack(unsigned long fileOffset, unsigned short  * pData);
    unsigned short     FOE_Busy(unsigned short done, unsigned long fileOffset, unsigned short  * pData);
    void       FOE_Error(unsigned long errorCode);


 
#line 54 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.c"
...
#line 58 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.c"
...
#line 347 "..\\For_SSC_Tool\\Src\\ecatslv.h"
...
#line 62 "..\\For_SSC_Tool\\Src\\foeappl.h"
...
#line 59 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.c"
#line 1 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
...
#line 52 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
#line 53 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
#line 54 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
#line 1 "..\\For_SSC_Tool\\Src\\esc.h"
...
#line 55 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
#line 1 "..\\For_SSC_Tool\\Src\\ecatslv.h"
...
#line 56 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
#line 1 "..\\For_SSC_Tool\\Src\\objdef.h"
...
#line 57 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
#line 1 "..\\For_SSC_Tool\\Src\\ecatappl.h"
...
#line 58 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
...
#line 64 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.h"
...
extern unsigned short AX58200_FoeRead(unsigned short  * pName, unsigned short nameSize, unsigned long password, unsigned short maxBlockSize, unsigned short *pData);
extern unsigned short AX58200_FoeReadData(unsigned long offset, unsigned short maxBlockSize, unsigned short *pData);
extern void AX58200_FoeError(unsigned long errorCode);
extern unsigned short AX58200_FoeWrite(unsigned short  * pName, unsigned short nameSize, unsigned long password);
extern unsigned short AX58200_FoeWriteData(unsigned short  * pData, unsigned short Size, unsigned char bDataFollowing);
extern void AX58200_FoeInit(void);

 
#line 60 "..\\For_SSC_Tool\\Src\\AX58200_FoeAppl.c"
...
unsigned long              nFileWriteOffset;
char                aFileName[16];
unsigned short        aFileData[(0x180 >> 1)];
const unsigned short    aFirmwareDownloadHeader[4] = {0x5841, 0x3835, 0x3032, 0x5F30}; 
...
unsigned short AX58200_FoeRead(unsigned short  * pName, unsigned short nameSize, unsigned long password, unsigned short maxBlockSize, unsigned short *pData)
{
	unsigned short	size = 0;
	unsigned short	i = 0;
	char	aReadFileName[16];
	...
	memcpy(aReadFileName, pName, nameSize);
	 ...
	 
	{
		...
		if (nFileSize >= (u16SendMbxSize - sizeof(TFOEHEADER) - 6))
		{
			size = (u16SendMbxSize - sizeof(TFOEHEADER) - 6);
		}
		else
		{
			size = (unsigned short) nFileSize;
		}
		memcpy(pData, aFileData, size);
	}
	return size;
}
...
unsigned short AX58200_FoeWrite(unsigned short  * pName, unsigned short nameSize, unsigned long password)
{
    ...
    else if (nameSize < 16)
    {
        ...
        memcpy(aFileName, pName, nameSize);
        memcpy(aFileName+nameSize, "\0", 1); 
...
unsigned short AX58200_FoeWriteData(unsigned short  * pData, unsigned short Size, unsigned char bDataFollowing)
{
	if (bBootMode)
	{
		return BL_Data(pData, Size);
	}
	else if ((nFileWriteOffset + Size) > 0x180)
	{
		return 0x8003;
	}
	...
	if (Size)
	{ 
		memcpy(&aFileData[(nFileWriteOffset >> 1)], pData, Size);
	}
...
unsigned short AX58200_FoeReadData(unsigned long offset, unsigned short maxBlockSize, unsigned short *pData)
{
	if (offset < nFileSize)
    {
         
        unsigned long size;
        unsigned long sendSize = nFileSize - offset;

        if (sendSize >= (u16SendMbxSize - sizeof(TFOEHEADER) - 6))
        {
            size = (u16SendMbxSize - sizeof(TFOEHEADER) - 6);
        }
        else
        ...
        memcpy(pData, &aFileData[(offset >> 1)], size);
...
void AX58200_FoeError(unsigned long errorCode)
{
	if (nFileWriteOffset)
	{
		 
		memset(aFileName, 0, 16);
		nFileWriteOffset = 0;
		nFileSize = 0;
	}
}
