...
#line 33 "..\\Source\\McStack\\flash.c"
...
#line 34 "..\\Source\\McStack\\flash.c"
...
#line 35 "..\\Source\\McStack\\flash.c"
...
#line 36 "..\\Source\\McStack\\flash.c"
...
void MS_GetFlashParamsAreaData(void)
{
	...
	if (MS_CalcCheckSum((0x38000)))
	{
		FlashObj.BaseAddr = (0x38000);
	}
	else if(MS_CalcCheckSum((0x78000)))
	{
		FlashObj.BaseAddr = (0x78000);
	}
